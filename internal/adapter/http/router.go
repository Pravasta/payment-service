...
func NewRouter(
	...
	r.Route("/v1", func(r chi.Router) {
		...
		r.With(appmw.RequireScope("payments:write")).Post("/payments", payments.Create)
		...
		r.With(appmw.RequireScope("payments:write")).Post("/payments/{id}/refunds", payments.Refund)
